...
function Profile() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-200 to-purple-300 p-4 sm:p-6">
      <div className="bg-white shadow-lg rounded-xl p-6 w-full max-w-lg">
        <h1 className="text-2xl sm:text-3xl font-bold text-center text-gray-800 mb-6">Admin Profile</h1>
        <span className="block text-gray-600 mb-4 break-words">
          Email: <strong>{data.email}</strong>
        </span>
        <div className="mt-6">
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-4">Change Password</h2>
          <input
            type="password"
            placeholder="Current Password"
            value={currentPassword}
